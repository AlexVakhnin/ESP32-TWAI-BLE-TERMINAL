...
class TwaiCAN {
 ...
 private:
 //Значения по умолчанию для инициализации CAN драйвера
    bool init = false;
    int8_t tx = 5;
    int8_t rx = 4;
...
extern TwaiCAN ESP32Can; //создаем класс с именем ESP32Can (обьявление)
